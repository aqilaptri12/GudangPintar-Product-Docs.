# ��� User Guide: Inbound Processing (Penerimaan Barang)
...
4.  Masukkan **Jumlah Diterima (Qty)**.
    > **⚠️ PERINGATAN:** > Jika fisik barang rusak (*damaged*), jangan masukkan ke kolom 'Good Stock'. Gunakan tombol **'Report Damage'** di pojok kanan atas.
